#!/usr/bin/env python3
"""Generate story voiceover MP3 files.
...
LINES = [
    {
        "file": "prologue_narrator.mp3",
        "voice": "zh-CN-YunyangNeural",
        "rate": "+8%",
        "text": "月雾落下，边境塔阵全灭。古园中心，最后一枚萝卜核心还在发光。它不是粮食，是最后的虚空封印。",
    },
    {
        "file": "prologue_guardian.mp3",
        "voice": "zh-CN-XiaoxiaoNeural",
        "rate": "+0%",
        "text": "你们想拔萝卜，也得先过我的塔阵。",
    },
    {
        "file": "prologue_warlord.mp3",
        "voice": "zh-CN-YunxiNeural",
        "rate": "-8%",
        "text": "把它拔出来，世界就会安静。",
    },
    {
        "file": "endless_narrator.mp3",
        "voice": "zh-CN-YunyangNeural",
        "rate": "+6%",
        "text": "封印没有被拔出来，但虚空已经学会绕路。敌潮不再排队，只会一波比一波更硬。",
    },
    {
        "file": "endless_guardian.mp3",
        "voice": "zh-CN-XiaoxiaoNeural",
        "rate": "+0%",
        "text": "把塔阵接到核心上，能撑几波就撑几波。",
    },
    {
        "file": "endless_warlord.mp3",
        "voice": "zh-CN-YunxiNeural",
        "rate": "-8%",
        "text": "甜味会散尽，守夜人也会。",
    },
